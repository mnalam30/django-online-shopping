...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VoucherUser'
        db.create_table('vouchers_voucheruser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voucher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vouchers.Voucher'], related_name='users')),
        ...
        db.send_create_signal('vouchers', ['VoucherUser'])

        # Adding field 'Voucher.user_limit'
        db.add_column('vouchers_voucher', 'user_limit',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'VoucherUser'
        db.delete_table('vouchers_voucheruser')

        # Deleting field 'Voucher.user_limit'
        db.delete_column('vouchers_voucher', 'user_limit')
    ...
    models = {
        ...
        'vouchers.voucher': {
            'Meta': {'ordering': "['created_at']", 'object_name': 'Voucher'},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vouchers.Campaign']", 'blank': 'True', 'null': 'True', 'related_name': "'vouchers'"}),
        ...
        'vouchers.voucheruser': {
            'Meta': {'object_name': 'VoucherUser'},
            'voucher': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vouchers.Voucher']", 'related_name': "'users'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'redeemed_at': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['auth.User']"})
        }
