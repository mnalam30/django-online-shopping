...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'VoucherUser', fields ['voucher', 'user']
        db.create_unique('vouchers_voucheruser', ['voucher_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'VoucherUser', fields ['voucher', 'user']
        db.delete_unique('vouchers_voucheruser', ['voucher_id', 'user_id'])
    ...
    models = {
        ...
        'vouchers.voucher': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vouchers'", 'null': 'True', 'blank': 'True', 'to': "orm['vouchers.Campaign']"}),
        ...
        'vouchers.voucheruser': {
            'Meta': {'object_name': 'VoucherUser', 'unique_together': "(('voucher', 'user'),)"},
