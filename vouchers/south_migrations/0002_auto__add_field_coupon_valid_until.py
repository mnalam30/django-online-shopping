...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Voucher.valid_until'
        db.add_column(u'vouchers_voucher', 'valid_until',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Voucher.valid_until'
        db.delete_column(u'vouchers_voucher', 'valid_until')
