...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for voucher in orm['vouchers.Voucher'].objects.all():
            if voucher.user is not None or voucher.redeemed_at is not None:
                orm['vouchers.VoucherUser'].objects.create(
                    voucher=voucher,
                    user=voucher.user,
    ...
    models = {
        ...
        'vouchers.voucher': {
            ...
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['vouchers.Campaign']", 'related_name': "'vouchers'", 'blank': 'True'}),
