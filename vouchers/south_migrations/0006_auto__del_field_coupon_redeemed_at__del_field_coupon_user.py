...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Voucher.redeemed_at'
        db.delete_column('vouchers_voucher', 'redeemed_at')

        # Deleting field 'Voucher.user'
        db.delete_column('vouchers_voucher', 'user_id')

    def backwards(self, orm):
        # Adding field 'Voucher.redeemed_at'
        db.add_column('vouchers_voucher', 'redeemed_at',
                      self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'Voucher.user'
        db.add_column('vouchers_voucher', 'user',
    ...
    models = {
        ...
        'vouchers.voucher': {
            'Meta': {'object_name': 'Voucher', 'ordering': "['created_at']"},
            'campaign': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'vouchers'", 'to': "orm['vouchers.Campaign']", 'null': 'True', 'blank': 'True'}),
        ...
        'vouchers.voucheruser': {
            ...
            'voucher': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'users'", 'to': "orm['vouchers.Voucher']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
